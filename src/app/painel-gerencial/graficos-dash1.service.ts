...
export class GraficosDash1Service {
   ...
   importarVersoes(): Observable<any[]>{
      return  this.http.get(`${API_CONFIG}/appPerformance/VersoesOrcados`,this.httpOptions) 
      .pipe(map((res : any[]) => res, catchError(ErrorHandler.handleError)))
   }
   importarCalculos(empresa,agesg,datini,datfim,versao): Observable<any[]>{
      return  this.http.get(`${API_CONFIG}/appPerformance/OrcadoRealizado/${empresa}/${agesg}/${datini}/${datfim}/${versao}`,this.httpOptions) 
      .pipe(map((res : any[]) => res, catchError(ErrorHandler.handleError)))
   }
   ...
   //------------------------------------------------------------------------------
   //Orçamento
   carregarOrcadosTotais(agesg,datini,datfim,versao): Observable<any[]>{
      return  this.http.get(`${API_CONFIG}/appPerformanceOrcReal/OrcadoRealizadoTotais/${agesg}/${datini}/${datfim}/${versao}`,this.httpOptions) 
      .pipe(map((res : any[]) => res, catchError(ErrorHandler.handleError)))
   }
   carregarUnidadesPorGrupo(grupo,agesg,datini,datfim,versao): Observable<any[]>{
      return  this.http.get(`${API_CONFIG}/appPerformanceOrcReal/OrcadoPorUnidade/${grupo}/${agesg}/${datini}/${datfim}/${versao}`,this.httpOptions) 
      .pipe(map((res : any[]) => res, catchError(ErrorHandler.handleError)))
   }
}
