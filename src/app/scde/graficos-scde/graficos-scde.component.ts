...
@Component({
  selector: 'app-graficos-scde',
  templateUrl: './graficos-scde.component.html',
  styleUrls: ['./graficos-scde.component.css']
})
export class GraficosSCDEComponent implements OnInit {
  tiposDeExtracao
  unidadesLista
  ...
  carregarDados(){
    ...
    if(this.date1==null || this.date2==null){
      ...
      this.serv.importarGraficosSCDE(this.tipoSelecionado,this.unidadeSelecionada.id,inicio,fim).subscribe(
        res=>{
