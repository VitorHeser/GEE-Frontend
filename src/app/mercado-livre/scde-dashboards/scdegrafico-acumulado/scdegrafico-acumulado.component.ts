...
@Component({
  selector: 'app-scdegrafico-acumulado',
  templateUrl: './scdegrafico-acumulado.component.html',
  styleUrls: ['./scdegrafico-acumulado.component.css']
})
export class SCDEGraficoAcumuladoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var unidades:string[] =[]
    for(var i =0;i<this.unidade.length;i++){
      unidades.push(this.unidade[i].unidade.unidade)
    }
    
    this.serv.Grafico1Acumulado(unidades,this.ref,this.tipo).subscribe(
      resp=>{
