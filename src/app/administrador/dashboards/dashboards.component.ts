...
export class DashboardsComponent implements OnInit {
  ...
  constructor(
    ...
    private auditServ:AuditoriasService     ) { }
  ...
  ngOnInit() {
    ...
    this.nomeParaFaturas = adm==true ? "adm" : us.login
    this.refParaFaturas = this.RefAtual(new Date())
    this.auditServ.QtdFaturas(this.refParaFaturas ,this.nomeParaFaturas).subscribe(
      resp=>{
        this.qtdNotific=resp
      }
    );
